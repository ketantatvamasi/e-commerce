        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form role="form" id="addproduct" class="row g-3 needs-validation" method="post"  action="{{route('updateWomanProduct')}}" enctype="multipart/form-data" novalidate>
                            {{csrf_field()}}
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea rows="4" placeholder="Decription" class="form-control" name="decription" id="decription" required>{{$product->decription}}</textarea>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control" name="mrp_price" id="mrp_price" placeholder="MRP price" value="{{$product->mrp_price}}" required>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control" name="saleing_price" id="saleing_price" placeholder="Saleing price" value="{{$product->saleing_price}}" required>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-3">
                                ...
                                <select class="form-select" name="brand_id" id="brand_id" required>
                                    ...
                                    @foreach ($brand as $key => $value)
                                        <option value="{{ $value->id }}"{{ ($value->id == $product->brand_id) ? 'selected' : '' }}>  {{ $value->brand_name}}</option>
...
{{--                                        <option value="{{$value->id}}" @foreach($product_size as $ps) @if($value->id == $ps->size_id)selected="selected"@endif @endforeach>{{ $value->size}}</option>--}}
{{--                                    @endforeach--}}
                                    @foreach ($size as $key => $value)
                                        <option value="{{$value->id}}" @if(in_array($value->id, $size_id) ) selected @endif >{{ $value->size}}</option>
                                    @endforeach
                                </select>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-6">
                                <table id="feature" class="table mb-0">
                                    ...
                                    @foreach($feature as $value)
                                       ...
                                       <tr class="item_row">
                                           <td>
                                               <input type="text" class="form-control"  name="data[@php echo $count; @endphp][name]" id="name_@php echo $count; @endphp" placeholder="Name" value="{{$value->name}}" required>
                                               <div class="invalid-feedback">
                                                   Please enter the name.
                                               </div>
                                           </td>
                                           <td>
                                               <input type="text" class="form-control"  name="data[@php echo $count; @endphp][value]" id="value_@php echo $count; @endphp   " placeholder="Value" value="{{$value->value}}" required>
                                               <div class="invalid-feedback">
                                           ...
                                           <td>
                                               @if($count == 1)
                                               <a href="javascript:void(0);" id="addfield" class="btn btn-success addfield">
                                               ...
                                               @else
                                                   ...
                                                   <a href="javascript:;" id="deletefield" class="btn btn-danger">
        ...
        @push('script')
            ...
            <script>
                ...
                function deleteImage(id){
                    ...
                    $.ajax({
                        url: "{{route('deleteWomanProductImage')}}",
                        type: "POST",
                        dataType: "json",
                        data: {
                            '_token': token,
