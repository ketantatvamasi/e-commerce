                ...
                <main class="main__content_wrapper">
                    <form action="{{route('storePayment')}}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 mb-12">
                                        <div class="checkout__input--list ">
                                            <label>
                                                <input type="text" class="checkout__input--field border-radius-5" name="name" id="name" value="{{ old('name') }}" placeholder="Full name">
                                            </label>
                                            @if ($errors->any())
                                                <div>
                                    ...
                                    <div class="col-12 mb-12">
                                        <div class="checkout__input--list">
                                            <label>
                                                <input type="email" class="checkout__input--field border-radius-5" name="email" id="email" value="{{ old('email') }}" placeholder="Email Address">
                                            </label>
                                            @if ($errors->any())
                                                <div>
                                                    @php $error = $errors->all();@endphp
                                    ...
                                    <div class="col-12 mb-12">
                                        <div class="checkout__input--list">
                                            <label>
                                                <input type="text" class="checkout__input--field border-radius-5" name="mobile" id="mobile" value="{{ old('mobile') }}" placeholder="Mobile Number">
                                            </label>
                                            @if ($errors->any())
                                                <div>
                                                    @php $error = $errors->all();@endphp
                                    ...
                                    <div class="col-12 mb-12">
                                        <div class="checkout__input--list">
                                            <label>
                                                <input type="text" class="checkout__input--field border-radius-5" name="amount" id="amount" value="{{$total}}" placeholder="Amount" readonly>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="checkout__content--step__footer d-flex align-items-center">
                            <button class="continue__shipping--btn primary__btn border-radius-5" type="submit">Place Order</button>
                            <a class="previous__link--content" href="{{route('checkout')}}">Return to shipping</a>
                        </div>
                    </form>
                </main>
                <footer class="main__footer checkout__footer">
                    <p class="copyright__content">Copyright © 2022 . All Rights Reserved.Design </p>
                </footer>
            </div>
