...
{{--                                class="header__shipping--text__link" href="mailto:demo@gmail.com">demo@gmail.com</a>--}}
{{--                        </li>--}}
                    </ul>
                </div>
        ...
        <div class="container-fluid">
            <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
                ...
                <div class="main__logo">
                    {{--<h1 class="main__logo--title"><a class="main__logo--link" href="javascript:void(0)"><img class="main__logo--img" src="{{asset('assets/frontend/img/logo/nav-log.png')}}" alt="logo-img"></a></h1>--}}
                </div>
...
{{--                        <li class="header__account--items">--}}
                            ...
                            <ul class="header__sub--menu">
                                ...
                                <li class="header__sub--menu__items">
                                    <a class="header__sub--menu__link" href="{{ route('user.logout') }}"
...
{{--                            </li>--}}
                            ...
                            @if (Auth::check())
                                <li class="header__menu--items mega__menu--items">
                                    <a class="header__menu--link text-white" href="javascript:void(0)">Category
                                    ...
                                    <ul class="header__mega--menu d-flex">
                                        @foreach($catArr as $value)
                                            <li class="header__mega--menu__li">
                                                <span class="header__mega--subtitle">{{$value['name']}}</span>
                                                <ul class="header__mega--sub__menu">
                                                    @foreach($value['submenu'] as $item)
                                                        <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="#">{{$item['name']}}</a></li>
                                                    @endforeach
                                                </ul>
                                            </li>
                                        @endforeach
                            ...
                            @endif
                            <li class="header__menu--items style2">
                                <a class="header__menu--link text-white" href="javascript:void(0)">About US </a>
                            </li>
                            <li class="header__menu--items style2">
                                <a class="header__menu--link text-white" href="javascript:void(0)">Contact </a>
                            </li>
                        </ul>
                    </nav>
                </div>
                    ...
                    <ul class="d-flex">
                        ...
                        <li class="header__account--items header__account2--items">
                            <a class="header__account--btn minicart__open--btn" href="javascript:void(0)" data-offcanvas>
                                ...
                                <span class="items__count style2">{{ count((array) session('cart'))+ count((array) session('cart2'))}}</span>
                            </a>
                        </li>
                    </ul>
                </div>
        ...
        <div class="container-fluid">
            <div
                ...
                <div class="header__menu">
                    <nav class="header__menu--navigation" id="topBar">
                        <ul class="d-flex">
...
{{--                            </li>--}}
                            ...
                            @if (Auth::check())
                            <li class="header__menu--items d-none d-xl-block menu">
                                <a class="header__menu--link text-white" href="#">Categories
...
{{--                    <img src="{{asset('assets/frontend/img/logo/nav-log.png')}}" alt="Grocee Logo" width="158"--}}
{{--                         height="36">--}}
                </a>
                        ...
                        <li class="language__currency--list">
                            <a class="offcanvas__language--switcher" href="#">
                                <img class="language__switcher--icon__img"
                                     src="{{asset('assets/frontend/img/icon/language-icon.png')}}" alt="currency">
                                <span>English</span>
    ...
    <div class="offcanvas__stikcy--toolbar">
        <ul class="d-flex justify-content-between">
            <li class="offcanvas__stikcy--toolbar__list">
                <a class="offcanvas__stikcy--toolbar__btn" href="{{route('dashboard')}}">
...
{{--                    {{$details['user_id']}}--}}
                    <div class="id" data-id="{{ $id }}">
                        <div class="minicart__product--items d-flex">
                            ...
                            <div class="minicart__text">
                                <h3 class="minicart__subtitle h4"><a href="#">{{$details['name']}}</a></h3>
                                <div class="minicart__price">
                                    <span class="current__price">₹{{$details['saleing_price']}}</span>
                                    <span class="old__price">₹{{$details['mrp_price']}}</span>
                                </div>
                                <div class="minicart__text--footer d-flex align-items-center">
                                    <div class="quantity__box minicart__quantity">
                                        <button type="button" class="quantity__value decrease minus" aria-label="quantity value" value="Decrease Value">-</button>
                                        <label>
                                            <input type="number" class="quantity__number" id="quantity_{{ $id }}" value="{{ $details['quantity'] }}" data-counter/>
                                        </label>
                                        <button type="button" class="quantity__value increase plus" id="plus" value="Increase Value">+</button>
                                    </div>
                                    <button class="minicart__product--remove remove-from-cart">Remove</button>
                                </div>
                    ...
                    <div class="id" data-id="{{ $id }}">
                        <div class="minicart__product--items d-flex">
                            ...
                            <div class="minicart__text">
                                ...
                                <div class="minicart__text--footer d-flex align-items-center">
                                    <div class="quantity__box minicart__quantity">
                                        <button type="button" class="quantity__value decrease minus2" aria-label="quantity value" value="Decrease Value">-</button>
                                        <label>
                                            <input type="number" class="quantity__number" id="quantity_{{ $id }}" value="{{ $details['quantity'] }}" data-counter/>
                                        </label>
                                        <button type="button" class="quantity__value increase plus2" id="plus" value="Increase Value">+</button>
                                    </div>
                                    <button class="minicart__product--remove remove-from-cart2">Remove</button>
                                </div>
            ...
            <div class="col-lg-12 col-sm-12 col-12 total-section text-right ">
                <b><p class="mt-4">Total: <span class="text-info">₹ {{ $total }}</span></p></b>
            </div>
        </div>
        ...
        <div class="minicart__conditions text-center">
            ...
            <label class="minicart__conditions--label" for="accept">I agree with the <a
                    class="minicart__conditions--link" href="javascript:void(0)">Privacy and Policy</a></label>
        </div>
        <div class="minicart__button d-flex justify-content-center">
            <a class="primary__btn minicart__button--link" href="javascript:void(0)">View cart</a>
            @if($total == 0)
                <a class="primary__btn minicart__button--link" href="javascript:void(0)">Checkout</a>
            @else
