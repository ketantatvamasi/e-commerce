            ...
            <div class="header__topbar--inner d-flex align-items-center justify-content-between">
                <div class="header__shipping">
                    <ul class="header__shipping--wrapper d-flex">
                        ...
                        <li class="header__shipping--text text-white d-sm-2-none"><img class="header__shipping--text__icon" src="{{asset('assets/frontend/img/icon/bus.png')}}" alt="bus-icon"> Track Your Order</li>
                        <li class="header__shipping--text text-white d-sm-2-none"><img class="header__shipping--text__icon" src="{{asset('assets/frontend/img/icon/email.png')}}" alt="email-icon"> <a class="header__shipping--text__link" href="mailto:demo@gmail.com">demo@gmail.com</a></li>
                    </ul>
                </div>
        ...
        <div class="container-fluid">
            <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
                ...
                <div class="main__logo">
                    <h1 class="main__logo--title"><a class="main__logo--link" href="index.html"></a></h1>
                </div>
    ...
    <div class="header__bottom">
        <div class="container-fluid">
            <div class="header__bottom--inner position__relative d-none d-lg-flex justify-content-between align-items-center">
                ...
                <p class="header__discount--text"><img class="header__discount--icon__img" src="{{asset('assets/frontend/img/icon/lamp.png')}}" alt="lamp-img"> Special up to 60% Off all item</p>
            </div>
        </div>
    </div>
        ...
        <div class="offcanvas__inner">
            <div class="offcanvas__logo">
                <a class="offcanvas__logo_link" href="index.html">
                    <img src="{{asset('assets/frontend/img/logo/nav-log.png')}}" alt="Grocee Logo" width="158" height="36">
                </a>
        ...
        <div class="minicart__product">
            <div class="minicart__product--items d-flex">
                <div class="minicart__thumb">
                    <a href="product-details.html"><img src="{{asset('assets/frontend/img/product/product1.png')}}" alt="prduct-img"></a>
                </div>
            ...
            <div class="minicart__product--items d-flex">
                <div class="minicart__thumb">
                    <a href="product-details.html"><img src="{{asset('assets/frontend/img/product/product2.png')}}" alt="prduct-img"></a>
                </div>
                <div class="minicart__text">
