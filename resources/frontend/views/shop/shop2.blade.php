                                                        ...
                                                        <div class="product__items--content">
                                                            ...
                                                            <ul class="product__items--action d-flex">
                                                                <li class="product__items--action__list">
                                                                    <a class="product__items--action__btn add__to--cart" href="{{ route('add.to.cart2', $value['id']) }}">
                                                    ...
                                                    <div class="id" data-id="{{ $value['id'] }}">
                                                        ...
                                                        <div class="product__items--thumbnail product__list--items__thumbnail">
                                                            ...
                                                            <a class="product__items--link" href="#">
                                                                @for($i=0; $i<$n; $i++)
                                                                    @if($i==0)
                                                                        <img class="product__items--img product__primary--img" src="{{asset('images/'.$img[$i])}}" height="10" alt="product-img">
                                                                    @endif
                                                                    @if($i==1)
                                                                        <img class="product__items--img product__secondary--img" src="{{asset('images/'.$img[$i])}}" height="10" alt="product-img">
                                                                    @endif
                                                                @endfor
                                                            </a>
                                                            <div class="product__badge">
                                                        ...
                                                        <div class="product__list--items__content">
                                                            <span class="product__items--content__subtitle mb-5">{{$value['category_name']}}, {{$value['subcategory_name']}}</span>
                                                            <h3 class="product__list--items__content--title h4 mb-10"><a href="#">{{$value['product_name']}}</a></h3>
