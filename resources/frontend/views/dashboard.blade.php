                                    ...
                                    <div class="row row-cols-1">
                                        <div class="col">
                                            <div class="slider__content">
                                                <p class="slider__content--desc desc1 mb-15"><img class="slider__text--shape__icon" src="{{asset('assets/frontend/img/icon/text-shape-icon.png')}}" alt="text-shape-icon"> New Collection</p>
                                                ...
                                                <a class="slider__btn primary__btn" href="javascript:void(0)">Show Collection
                                    ...
                                    <div class="col">
                                        <div class="hero__slider--items__inner">
                                            <div class="slider__content">
                                                ...
                                                <p class="slider__content--desc desc2 d-sm-2-none mb-40 ">Up To 40% Off Final Sale Items. <br>
                                                    Caught in the Moment!</p>
                                                <a class="primary__btn slider__btn" href="javascript:void(0)">Show Collection
                ...
                <div class="row mb--n28">
                    <div class="col-lg-5 col-md-order mb-28">
                        <div class="banner__items">
                            <a class="banner__items--thumbnail position__relative" href="javascript:void(0)"><img class="banner__items--thumbnail__img" src="{{asset('assets/frontend/img/banner/banner1.png')}}" alt="banner-img">
                    ...
                    <div class="col-lg-7 mb-28">
                        <div class="row row-cols-lg-2 row-cols-sm-2 row-cols-1">
                            <div class="col mb-28">
                                <div class="banner__items">
                                    <a class="banner__items--thumbnail position__relative" href="javascript:void(0)"><img class="banner__items--thumbnail__img" src="{{asset('assets/frontend/img/banner/banner2.png')}}" alt="banner-img">
                                        <div class="banner__items--content">
                            ...
                            <div class="col mb-28">
                                <div class="banner__items">
                                    <a class="banner__items--thumbnail position__relative" href="javascript:void(0)"><img class="banner__items--thumbnail__img" src="{{asset('assets/frontend/img/banner/banner3.png')}}" alt="banner-img">
                                        <div class="banner__items--content">
                        ...
                        <div class="banner__items">
                            <a class="banner__items--thumbnail position__relative" href="javascript:void(0)"><img class="banner__items--thumbnail__img banner__img--max__height" src="{{asset('assets/frontend/img/banner/banner4.png')}}" alt="banner-img">
                                <div class="banner__items--content">
                                ...
                                @foreach($product as $value)
                                    ...
                                    <div class="product__items ">
                                        <div class="product__items--thumbnail">
                                            ...
                                            <a class="product__items--link" href="#">
                                                @for($i=0; $i<$n; $i++)
                                                    ...
                                                    @endif
                                                    @if($i==1)
                                                        <img class="product__items--img product__secondary--img" src="{{asset('images/'.$img[$i])}}" alt="product-img">
                                                    @endif
                                                @endfor
                                            </a>
                                        ...
                                        <div class="product__items--content">
                                            <span class="product__items--content__subtitle">{{$value['category_name']}}, {{$value['subcategory_name']}}</span>
                                            <h3 class="product__items--content__title h4"><a href="#">{{$value['product_name']}}</a></h3>
                                            ...
                                            <ul class="product__items--action d-flex">
                                                <li class="product__items--action__list">
                                                    <a class="product__items--action__btn add__to--cart" href="{{ route('add.to.cart', $value['id']) }}">
                            ...
                            <div class="row row-cols-xl-5 row-cols-lg-4 row-cols-md-3 row-cols-2 mb--n30">
                                    ...
                                    <div class="product__items ">
                                        <div class="product__items--thumbnail">
                                            <a class="product__items--link" href="javascript:void(0)">
                                                <img class="product__items--img product__primary--img" src="{{asset('assets/frontend/img/product/product8.png')}}" alt="product-img">
                                                <img class="product__items--img product__secondary--img" src="{{asset('assets/frontend/img/product/product15.png')}}" alt="product-img">
                                            </a>
                                            <div class="product__badge">
                                                <span class="product__badge--items sale">Sale</span>
                                            </div>
                                        ...
                                        <div class="product__items--content">
                                            ...
                                            <h4 class="product__items--content__title"><a href="javascript:void(0)">Square Shoulder Bag</a></h4>
                                            <div class="product__items--price">
                                ...
                                <div class="col mb-30">
                                    <div class="product__items ">
                                        <div class="product__items--thumbnail">
                                            <a class="product__items--link" href="javascript:void(0)">
                                                <img class="product__items--img product__primary--img" src="{{asset('assets/frontend/img/product/product9.png')}}" alt="product-img">
                                                <img class="product__items--img product__secondary--img" src="{{asset('assets/frontend/img/product/product10.png')}}" alt="product-img">
                                            </a>
                                            <div class="product__badge">
                                                <span class="product__badge--items sale">Sale</span>
                                            </div>
                                        ...
                                        <div class="product__items--content">
                                            <span class="product__items--content__subtitle">Jacket, Women</span>
                                            <h4 class="product__items--content__title"><a href="javascript:void(0)">Light Denim Jacket</a></h4>
                                            <div class="product__items--price">
                                ...
                                <div class="col mb-30">
                                    <div class="product__items ">
                                        <div class="product__items--thumbnail">
                                            <a class="product__items--link" href="javascript:void(0)">
                                                <img class="product__items--img product__primary--img" src="{{asset('assets/frontend/img/product/product12.png')}}" alt="product-img">
                                                <img class="product__items--img product__secondary--img" src="{{asset('assets/frontend/img/product/product13.png')}}" alt="product-img">
                                            </a>
                                            <div class="product__badge">
                                                <span class="product__badge--items sale">Sale</span>
                                            </div>
                                        ...
                                        <div class="product__items--content">
                                            <span class="product__items--content__subtitle">Jacket, Women</span>
                                            <h4 class="product__items--content__title"><a href="javascript:void(0)">Wool-blend Jacket</a></h4>
                                            <div class="product__items--price">
                                ...
                                <div class="col mb-30">
                                    <div class="product__items ">
                                        <div class="product__items--thumbnail">
                                            <a class="product__items--link" href="javascript:void(0)">
                                                <img class="product__items--img product__primary--img" src="{{asset('assets/frontend/img/product/product11.png')}}" alt="product-img">
                                                <img class="product__items--img product__secondary--img" src="{{asset('assets/frontend/img/product/product8.png')}}" alt="product-img">
                                            </a>
                                            <div class="product__badge">
                                                <span class="product__badge--items sale">Sale</span>
                                            </div>
                                        ...
                                        <div class="product__items--content">
                                            <span class="product__items--content__subtitle">Jacket, Women</span>
                                            <h4 class="product__items--content__title"><a href="javascript:void(0)">Aware organic cotton</a></h4>
                                            <div class="product__items--price">
                                ...
                                <div class="col mb-30">
                                    <div class="product__items ">
                                        <div class="product__items--thumbnail">
                                            <a class="product__items--link" href="javascript:void(0)">
                                                <img class="product__items--img product__primary--img" src="{{asset('assets/frontend/img/product/product14.png')}}" alt="product-img">
                                                <img class="product__items--img product__secondary--img" src="{{asset('assets/frontend/img/product/product15.png')}}" alt="product-img">
                                            </a>
                                            <div class="product__badge">
                                                <span class="product__badge--items sale">Sale</span>
                                        ...
                                        <div class="product__items--content">
                                            <span class="product__items--content__subtitle">Jacket, Women</span>
                                            <h4 class="product__items--content__title"><a href="javascript:void(0)">Western denim shirt</a></h4>
                                            <div class="product__items--price">
                                ...
                                <div class="col mb-30">
                                    <div class="product__items ">
                                        <div class="product__items--thumbnail">
                                            <a class="product__items--link" href="javascript:void(0)">
                                                <img class="product__items--img product__primary--img" src="{{asset('assets/frontend/img/product/product2.png')}}" alt="product-img">
                                                <img class="product__items--img product__secondary--img" src="{{asset('assets/frontend/img/product/product1.png')}}" alt="product-img">
                                            </a>
                                            <div class="product__badge">
                                                <span class="product__badge--items sale">Sale</span>
                                            </div>
                                        ...
                                        <div class="product__items--content">
                                            <span class="product__items--content__subtitle">Jacket, Women</span>
                                            <h4 class="product__items--content__title"><a href="javascript:void(0)">OSmock Mini Dresss</a></h4>
                                            <div class="product__items--price">
                                ...
                                <div class="col mb-30">
                                    <div class="product__items ">
                                        <div class="product__items--thumbnail">
                                            <a class="product__items--link" href="javascript:void(0)">
                                                <img class="product__items--img product__primary--img" src="{{asset('assets/frontend/img/product/product1.png')}}" alt="product-img">
                                                <img class="product__items--img product__secondary--img" src="{{asset('assets/frontend/img/product/product2.png')}}" alt="product-img">
                                            </a>
                                            <div class="product__badge">
                                                <span class="product__badge--items sale">Sale</span>
                                            </div>
                                        ...
                                        <div class="product__items--content">
                                            <span class="product__items--content__subtitle">Jacket, Women</span>
                                            <h3 class="product__items--content__title h4"><a href="javascript:void(0)">Oversize Cotton Dress</a></h3>
                                            <div class="product__items--price">
                                ...
                                <div class="col mb-30">
                                    <div class="product__items ">
                                        <div class="product__items--thumbnail">
                                            <a class="product__items--link" href="javascript:void(0)">
                                                <img class="product__items--img product__primary--img" src="{{asset('assets/frontend/img/product/product3.png')}}" alt="product-img">
                                                <img class="product__items--img product__secondary--img" src="{{asset('assets/frontend/img/product/product4.png')}}" alt="product-img">
                                            </a>
                                            <div class="product__badge">
                                                <span class="product__badge--items sale">Sale</span>
                                            </div>
                                        ...
                                        <div class="product__items--content">
                                            <span class="product__items--content__subtitle">Jacket, Women</span>
                                            <h3 class="product__items--content__title h4"><a href="javascript:void(0)">Boxy Denim Jacket</a></h3>
                                            <div class="product__items--price">
                                ...
                                <div class="col mb-30">
                                    <div class="product__items ">
                                        <div class="product__items--thumbnail">
                                            <a class="product__items--link" href="javascript:void(0)">
                                                <img class="product__items--img product__primary--img" src="{{asset('assets/frontend/img/product/product5.png')}}" alt="product-img">
                                                <img class="product__items--img product__secondary--img" src="{{asset('assets/frontend/img/product/product11.png')}}" alt="product-img">
                                            </a>
                                            <div class="product__badge">
                                                <span class="product__badge--items sale">Sale</span>
                                            </div>
                                        ...
                                        <div class="product__items--content">
                                            <span class="product__items--content__subtitle">Jacket, Women</span>
                                            <h4 class="product__items--content__title"><a href="javascript:void(0)">Quilted Shoulder Bag</a></h4>
                                            <div class="product__items--price">
                                ...
                                <div class="col mb-30">
                                    <div class="product__items ">
                                        <div class="product__items--thumbnail">
                                            <a class="product__items--link" href="javascript:void(0)">
                                                <img class="product__items--img product__primary--img" src="{{asset('assets/frontend/img/product/product6.png')}}" alt="product-img">
                                                <img class="product__items--img product__secondary--img" src="{{asset('assets/frontend/img/product/product7.png')}}" alt="product-img">
                                            </a>
                                            <div class="product__badge">
                                                <span class="product__badge--items sale">Sale</span>
                                            </div>
                                        ...
                                        <div class="product__items--content">
                                            <span class="product__items--content__subtitle">Jacket, Women</span>
                                            <h4 class="product__items--content__title"><a href="javascript:void(0)">High Ankle Jeans</a></h4>
                                            <div class="product__items--price">
                    ...
                    <div class="row row-cols-1 align-items-center">
                        <div class="col">
                            <div class="deals__banner--content position__relative">
                                ...
                                <div class="deals__banner--countdown d-flex" data-countdown="Jun 01, 2022 00:00:00"></div>
                                <a class="primary__btn" href="javascript:void(0)">Show Collection
                                    <svg class="primary__btn--arrow__icon" xmlns="http://www.w3.org/2000/svg" width="20.2" height="12.2" viewBox="0 0 6.2 6.2">
                                        <path d="M7.1,4l-.546.546L8.716,6.713H4v.775H8.716L6.554,9.654,7.1,10.2,9.233,8.067,10.2,7.1Z" transform="translate(-4 -4)" fill="currentColor"></path>
                                    </svg>
                                </a>
                ...
                <div class="row row-cols-md-2 row-cols-1 mb--n28">
                    <div class="col mb-28">
                        <div class="banner__items position__relative">
                            <a class="banner__items--thumbnail " href="javascript:void(0)"><img class="banner__items--thumbnail__img banner__img--max__height" src="{{asset('assets/frontend/img/banner/banner5.png')}}" alt="banner-img">
                                <div class="banner__items--content">
                    ...
                    <div class="col mb-28">
                        <div class="banner__items position__relative">
                            <a class="banner__items--thumbnail " href="javascript:void(0)"><img class="banner__items--thumbnail__img banner__img--max__height" src="{{asset('assets/frontend/img/banner/banner6.png')}}" alt="banner-img">
                                <div class="banner__items--content">
                ...
                <div class="testimonial__section--inner testimonial__swiper--activation swiper">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="testimonial__items text-center">
                                <div class="testimonial__items--thumbnail">
                                    <img class="testimonial__items--thumbnail__img border-radius-50" src="{{asset('assets/frontend/img/other/testimonial-thumb1.png')}}" alt="testimonial-img">
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial__items text-center">
                                <div class="testimonial__items--thumbnail">
                                    <img class="testimonial__items--thumbnail__img border-radius-50" src="{{asset('assets/frontend/img/other/testimonial-thumb2.png')}}" alt="testimonial-img">
                                </div>
                                <div class="testimonial__items--content">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial__items text-center">
                                <div class="testimonial__items--thumbnail">
                                    <img class="testimonial__items--thumbnail__img border-radius-50" src="{{asset('assets/frontend/img/other/testimonial-thumb3.png')}}" alt="testimonial-img">
                                </div>
                                <div class="testimonial__items--content">
                ...
                <div class="row row-cols-1">
                    <div class="col">
                        <div class="banner__section--inner position__relative">
                            <a class="banner__items--thumbnail display-block" href="javascript:void(0)"><img class="banner__items--thumbnail__img banner__img--height__md display-block" src="{{asset('assets/frontend/img/banner/banner-bg2.png')}}" alt="banner-img">
                ...
                <div class="blog__section--inner blog__swiper--activation swiper">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="blog__items">
                                <div class="blog__thumbnail">
                                    <a class="blog__thumbnail--link" href="javascript:void(0)"><img class="blog__thumbnail--img" src="{{asset('assets/frontend/img/blog/blog1.png')}}" alt="blog-img"></a>
                                </div>
                                <div class="blog__content">
                                    <span class="blog__content--meta">February 03, 2022</span>
                                    <h3 class="blog__content--title"><a href="javascript:void(0)">Fashion Trends In 2021 Styles,
                        ...
                        <div class="swiper-slide">
                            <div class="blog__items">
                                <div class="blog__thumbnail">
                                    <a class="blog__thumbnail--link" href="javascript:void(0)"><img class="blog__thumbnail--img" src="{{asset('assets/frontend/img/blog/blog2.png')}}" alt="blog-img"></a>
                                </div>
                                <div class="blog__content">
                                    <span class="blog__content--meta">February 03, 2022</span>
                                    <h3 class="blog__content--title"><a href="javascript:void(0)">Meet the Woman Behind Cool
                        ...
                        <div class="swiper-slide">
                            <div class="blog__items">
                                <div class="blog__thumbnail">
                                    <a class="blog__thumbnail--link" href="javascript:void(0)"><img class="blog__thumbnail--img" src="{{asset('assets/frontend/img/blog/blog3.png')}}" alt="blog-img"></a>
                                </div>
                                <div class="blog__content">
                                    <span class="blog__content--meta">February 03, 2022</span>
                                    <h3 class="blog__content--title"><a href="javascript:void(0)">Lauryn Hill Could Make Tulle
                        ...
                        <div class="swiper-slide">
                            <div class="blog__items">
                                <div class="blog__thumbnail">
                                    <a class="blog__thumbnail--link" href="javascript:void(0)"><img class="blog__thumbnail--img" src="{{asset('assets/frontend/img/blog/blog4.png')}}" alt="blog-img"></a>
                                </div>
                                <div class="blog__content">
                                    <span class="blog__content--meta">February 03, 2022</span>
                                    <h3 class="blog__content--title"><a href="javascript:void(0)">Fashion Trends In 2021 Styles,
